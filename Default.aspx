...
<%--<asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" 
      ...
      <br />
      <br />
      <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/smartphone_5.jpg" 
                    Width="100%" />
   </ContentTemplate>
<Triggers>
...
<body>
    ...
    <div style="height: 380px">
        ...
        <asp:Label ID="Label2" runat="server" Text="ShoppingCart"></asp:Label>
        <br />
        <br />
        <%--<asp:Label ID="Label3" runat="server" Text="Welcome to LetShop.com"></asp:Label>--%>
        ...
        <asp:DataList ID="DataList1" runat="server" BackColor="#DEBA84" 
            BorderColor="#DEBA84" BorderStyle="Solid" BorderWidth="1px" CellPadding="8" 
